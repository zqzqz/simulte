...
#define COIN_REQUEST_BYTE_SIZE (60 + MSG_HEADER_SIZE)
#define COIN_ASSIGNMENT_BYTE_SIZE (3000 + MSG_HEADER_SIZE)
#define COIN_DEPOSIT_BYTE_SIZE (3000 + MSG_HEADER_SIZE)
#define COIN_DEPOSIT_SIGNATURE_REQUEST_BYTE_SIZE (60 + MSG_HEADER_SIZE)
#define COIN_DEPOSIT_SIGNATURE_RESPONSE_BYTE_SIZE (60 + MSG_HEADER_SIZE)
#define COIN_SUBMISSION_BYTE_SIZE (3000 + MSG_HEADER_SIZE)
...
#define COIN_ASSIGNMENT_LATENCY_MEAN 0.100
...
#define COIN_DEPOSIT_SIGNATURE_REQUEST_LATENCY_MEAN 0.100
...
#define COIN_SUBMISSION_LATENCY_MEAN 0.100
