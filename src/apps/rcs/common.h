...
#define COIN_ASSIGNMENT_BYTE_SIZE (61 + MSG_HEADER_SIZE)
#define COIN_DEPOSIT_BYTE_SIZE (61 + MSG_HEADER_SIZE)
#define COIN_DEPOSIT_SIGNATURE_REQUEST_BYTE_SIZE (61 + MSG_HEADER_SIZE)
#define COIN_DEPOSIT_SIGNATURE_RESPONSE_BYTE_SIZE (61 + MSG_HEADER_SIZE)
#define COIN_SUBMISSION_BYTE_SIZE (61 + MSG_HEADER_SIZE)
