...
#define COIN_ASSIGNMENT_BYTE_SIZE (60 + MSG_HEADER_SIZE)
#define COIN_DEPOSIT_BYTE_SIZE (60 + MSG_HEADER_SIZE)
...
#define COIN_SUBMISSION_BYTE_SIZE (60 + MSG_HEADER_SIZE)
