...
class CarApp : public BaseApp, public cListener {
...
protected:
    ...
    /**
     * receiveSignal() is used to handle the position update signal
     */
    ...
    /**
     * handlePositionUpdate() is used to send message at some location
     */
