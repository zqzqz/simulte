...
#include "apps/streetcred/message/CoinRequest_m.h"
#include "apps/streetcred/message/CoinDeposit_m.h"
#include "apps/streetcred/message/CoinDepositSignatureResponse_m.h"

Define_Module(TCPCarApp);

void TCPCarApp::initialize(int stage)
{
...
void TCPCarApp::handlePositionUpdate(cObject* obj){
...
void TCPCarApp::receiveSignal(cComponent* source, simsignal_t signalID, cObject* obj, cObject* details){
    Enter_Method_Silent();
